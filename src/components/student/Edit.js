                ...
                <Grid item md={6} xs={12}>
                    ...
                    <form>
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12}>
                                <TextField autoComplete="mobile" name="mobile" variant="outlined" required fullWidth id="mobile" label="Mobile" value={student.mobile}  onChange={e => onTextFieldChange(e)} />
                            </Grid>
                        </Grid>
                        <Box m={3}>
